...
const paths = [
  ...
  "M -70 35 C -23 -3 3 -6 -48 188 C -3 49 50 155 89 259 C 87 302 101 203 146 224 C 179 238 155 219 186 215 C 147 169 206 208 206 173 C 207 134 243 145 263 133 C 272 127 237 126 281 109 C 380 66 432 50 300 -8 C 87 -21 85 34 -3 -42 Z",
];
const colors = [
  "var(--firstColor)",
  "var(--secondColor)",
